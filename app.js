...
app.use(
  ...
  require("./routes/admin/groupCategories")
);
app.use("/api/admin/events", require("./routes/admin/adminEvents"));
app.use(
  "/api/admin/events-categories",
  require("./routes/admin/adminEventCategories")
);
app.use(
  "/api/admin/payment-settings",
  require("./routes/admin/adminPaymentSettings")
);
app.use(
  "/api/admin/wallet-settings",
  require("./routes/admin/adminWalletSettings")
);
app.use(
  "/api/admin/earnings/packages",
  require("./routes/admin/adminPackagesEarnings")
);
